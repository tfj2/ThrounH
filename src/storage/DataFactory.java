...
public class DataFactory implements Database {
    ...
    public ArrayList<Accommodation> getAllHotels() {
        ...
        Accommodation acc2 = new Accommodation("2","Kea", "Akureyri", rooms2, managerIds);
        ArrayList<Room> rooms3 = new ArrayList<>();
        rooms3.add(new Room("5", 130, RoomType.Twin, 2));
        rooms3.add(new Room("6", 13243, RoomType.Quad, 4));
        Accommodation acc3 = new Accommodation("3","Hotel Selfoss", "Selfoss", rooms3, managerIds);
        ...
        Accommodation acc4 = new Accommodation("4","Grand", "Reykjavik", rooms4, managerIds);
        ...
        Accommodation acc5 = new Accommodation("5","Kjarnalundur", "Akureyri", rooms5, managerIds);
        ...
        Accommodation acc6 = new Accommodation("6","Hotel Cabin", "Reykjavik", rooms6, managerIds);
        ...
        Accommodation acc7 = new Accommodation("7","Nordica", "Reykjavik", rooms7, managerIds);
        ...
        Accommodation acc8 = new Accommodation("8","Midgardur", "Reykjavik", rooms8, managerIds);
        ...
        Accommodation acc9 = new Accommodation("9","201 Hotel", "Reykjavik", rooms9, managerIds);
        ...
        Accommodation acc10 = new Accommodation("10","Alda", "Reykjavik", rooms10, managerIds);
